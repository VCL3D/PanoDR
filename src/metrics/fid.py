...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', default='D:/Data/Paris/paris_eval_gt/', type=str)
    parser.add_argument('--output_path', default='D:/Data/Paris/out/', type=str)
    parser.add_argument('--fid_real_path', default='D:/Data/Paris/paris_eval_gt/', type=str)
